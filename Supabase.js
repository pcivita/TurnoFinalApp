...
const projectUrl = "https://mkdaoilcthudkfmkkhuo.supabase.co"
const newAnonKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im1rZGFvaWxjdGh1ZGtmbWtraHVvIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MDY3NDE4NDEsImV4cCI6MjAyMjMxNzg0MX0.l58T8TLUZ6_T-969M-BiCBxosdIBzhDA-swiSSRTTnc"
...
export default supabase = createClient(projectUrl, newAnonKey, {
  auth: {
